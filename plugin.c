...
VVCTRE_PLUGIN_EXPORT void PluginLoaded(void* core, void* plugin_manager,
    ...
    g_core = core;
    g_device = vvctre_button_device_new(plugin_manager, "general.limit_speed disable");
}
...
VVCTRE_PLUGIN_EXPORT void AfterSwapWindow() {
    ...
    if (was_pressed && !pressed) {
        ...
        vvctre_set_custom_touch_state(g_core, 0.018808777429467086, 0.02510460251046025, true);
        was_pressed = true;
    }
}
